...
//	__msg("dsk_theme_hdl2buf4\n");
    if(EPDK_TRUE == AZ100_IsCompress(pbuf, htheme->size_com))
    {
        __s32 ret;
//    	__msg("dsk_theme_hdl2buf5\n");    
    ...
    {
//    	__msg("dsk_theme_hdl2buf6\n");
        eLIBs_memcpy(htheme->buf, pbuf, htheme->size_com);
    }   
    
	esMEMS_Bfree(pbuf, htheme->size_com);	
	pbuf = NULL;		
//		__msg("dsk_theme_hdl2buf7\n");
    return htheme->buf;
}
