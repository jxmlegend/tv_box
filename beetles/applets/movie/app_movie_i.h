...
#include "prog/prog.h"
#include "movie_mute/movie_mute.h"
...
#define		MOVIE_SUB_SCENE_TYPE_ALL   (MOVIE_SPSC_ID|MOVIE_VOLUME_ID|MOVIE_BRIGHT_ID|MOVIE_PLAYSTA_ID|MOVIE_SUB_SHOW_ID|MOVIE_SUB_SET_ID\
    |MOVIE_PROG_ID|MOVIE_BREAKPLAY_DIALOG_ID|MOVIE_PLAYERROR_DIALOG_ID|MOVIE_PLAYEND_DIALOG_ID|MOVIE_MUTE_ID)
