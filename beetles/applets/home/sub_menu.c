...
typedef struct tag_res_tab_t
{
	...
	sm_res_id_t  res_media_id[5][MAX_SUB_ITEM];//video photo music ebook		//ID_MEDIA_END-ID_MEDIA_START
...
/*
	资源id号的表
*/
static sm_res_tab_t uipara_1024_768 =
{
	ID_HOME_SUB_LINE_BMP,
	ID_HOME_SUB_TOP_BMP,
	ID_HOME_SUB_BOTTOM_BMP,
	ID_HOME_SUB_BOTTOM_BMP,
	
	{
        {	//EXPLORER
    		{STRING_HOME_NULL_DISK, ID_HOME_SUB_NULL_NORMAL_BMP, ID_HOME_SUB_NULL_FOCUS_BMP},
    		{STRING_HOME_USB, ID_HOME_SUB_NULL_NORMAL_BMP, ID_HOME_SUB_NULL_FOCUS_BMP},
    		{STRING_HOME_SD, ID_HOME_SUB_NULL_NORMAL_BMP, ID_HOME_SUB_NULL_FOCUS_BMP},
    	},	
    	{	//photo	
    		{STRING_HOME_NULL_DISK, ID_HOME_SUB_NULL_NORMAL_BMP, ID_HOME_SUB_NULL_FOCUS_BMP},
    		{STRING_HOME_USB, ID_HOME_SUB_PHOTO_NORMAL_BMP, ID_HOME_SUB_PHOTO_FOCUS_BMP},
    		{STRING_HOME_SD, ID_HOME_SUB_PHOTO_NORMAL_BMP, ID_HOME_SUB_PHOTO_FOCUS_BMP},
    	},
    	{	//music
    		{STRING_HOME_NULL_DISK, ID_HOME_SUB_NULL_NORMAL_BMP, ID_HOME_SUB_NULL_FOCUS_BMP},
    		{STRING_HOME_USB, ID_HOME_SUB_MUSIC_NORMAL_BMP, ID_HOME_SUB_MUSIC_FOCUS_BMP},
    		{STRING_HOME_SD, ID_HOME_SUB_MUSIC_NORMAL_BMP, ID_HOME_SUB_MUSIC_FOCUS_BMP},
    	},
    	{	//movie
    		{STRING_HOME_NULL_DISK, ID_HOME_SUB_NULL_NORMAL_BMP, ID_HOME_SUB_NULL_FOCUS_BMP},
    		{STRING_HOME_USB, ID_HOME_SUB_VIDEO_NORMAL_BMP, ID_HOME_SUB_VIDEO_FOCUS_BMP},
    		{STRING_HOME_SD, ID_HOME_SUB_VIDEO_NORMAL_BMP, ID_HOME_SUB_VIDEO_FOCUS_BMP},
    	},
        {	//EXPLORER
    		{STRING_HOME_NULL_DISK, ID_HOME_SUB_NULL_NORMAL_BMP, ID_HOME_SUB_NULL_FOCUS_BMP},
    		{STRING_HOME_USB, ID_HOME_SUB_FILE_NORMAL_BMP, ID_HOME_SUB_FILE_FOCUS_BMP},
    		{STRING_HOME_SD, ID_HOME_SUB_FILE_NORMAL_BMP, ID_HOME_SUB_FILE_FOCUS_BMP},
    	},
	},
 /*   	{	//TV
...
/*
	...
	case GUI_SCNDIR_ROTATE180:
		{
			if((screen_width == 720 )&&( screen_height == 480))
...
//		case ID_HOME_EBOOK:
			{                
				if (smenu_attr->root_type == 0)
				{
					...
					smenu_attr->item_res_id[0] = sub_ui_para->res_media_id[smenu_attr->sub_menu_id][0];
				}
				else
				{
                        ...
                        &&(smenu_attr->root_type & 0xff00))//TF
					{
						...
						smenu_attr->item_res_id[0] = sub_ui_para->res_media_id[smenu_attr->sub_menu_id][1];
                        			smenu_attr->item_res_id[1] = sub_ui_para->res_media_id[smenu_attr->sub_menu_id][2];
					}
					...
					{
						smenu_attr->item_nr = 1;
						smenu_attr->item_res_id[0] = sub_ui_para->res_media_id[smenu_attr->sub_menu_id][2];
					}
					else 
					{
						__err("root type err....\n");
