...
static sm_res_tab_t uipara_400_240 =
{
	...
	
	{
        ...
        {	//EXPLORER
    		{STRING_HOME_NULL_DISK, ID_HOME_NULL_LOSE_BMP, ID_HOME_NULL_FOCUS_BMP},
    		{STRING_HOME_USB, ID_HOME_OTHERS_EXPLORER_LOSE_BMP, ID_HOME_OTHERS_EXPLORER_FOCUS_BMP},
    		{STRING_HOME_SD, ID_HOME_OTHERS_EXPLORER_LOSE_BMP, ID_HOME_OTHERS_EXPLORER_FOCUS_BMP},
    	},
	},
 /*   	{	//TV
    		{STRING_HOME_NULL_DISK, ID_HOME_NULL_LOSE_BMP, ID_HOME_NULL_FOCUS_BMP},
