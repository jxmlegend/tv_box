 ...
 */   
    ...
    {
/*
	{360,50,700-360,230-50},					//控制按钮背景区域()与频谱共用
    	{410,160,150,16},							//按键提示字符区域
    	{444,98,26,16},								//播放模式按钮  
    	{478,98,26,16},								//EQ模式按钮               
    	{514,98,26,16},								// 背光时间控制按钮             
    	
    	{408,135,26,16},							//上一首按钮                
    	{441,135,26,16},							//下一首按钮                
    	{474,135,26,16},							//播放暂停按钮              
    	{507,135,26,16},							//快退按钮                  
    	{540,135,26,16},							//快进按钮   
*/  
