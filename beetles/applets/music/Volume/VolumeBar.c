...
__s32 VolumeBarOnKeyProc(__gui_msg_t* msg)
{
	...
	if((KEY_DOWN_ACTION == msg->dwAddData2)||(KEY_REPEAT_ACTION == msg->dwAddData2))
	{
		if((msg->dwAddData1 == This->Para.Event.VolAddKey)
			||(msg->dwAddData1 == This->Para.Event.VolAddRepeatKey)||(msg->dwAddData1 ==GUI_MSG_IR_RIGHT)||(msg->dwAddData1 ==GUI_MSG_IR_LONGRIGHT))
		{
			VolumeBarOnAdd(This);			//音量加
		}
		if((msg->dwAddData1 == This->Para.Event.VolDecKey)
			||(msg->dwAddData1 == This->Para.Event.VolDecRepeatKey)||(msg->dwAddData1 ==GUI_MSG_IR_LEFT)||(msg->dwAddData1 ==GUI_MSG_IR_LONGLEFT))
		{
