...
static void __dv_record_media_info(__u32 sensorID)
{
    ...
    dv_core->media_info.uFileFmt                 = SW_VIDEO_FORMAT_MOV;
    dv_core->media_info.audio_inf.uAbsFmt   	   = SW_CODEC_TYPE_MPEG_AAC_LC;
    ...
    dv_core->media_info.video_inf.uVbsFmt        = SW_CODEC_TYPE_H264;
