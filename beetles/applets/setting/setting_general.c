...
static setting_item_id_t setting_general_res_id[] =
{
	...
	{STRING_SET_COMMON_PRODUCTINFO_EX, STRING_SET_COMMON_PRODUCTINFO_DE,STRING_SET_COMMON_PRODUCTINFO_TITLE,NULL,ID_SETTING_SET_BUTT_LF_BMP,ID_SETTING_SET_BUTT_RF_BMP},		// 2
	{STRING_SET_COMMON_FACTORY_DEFAULT_EX,STRING_SET_COMMON_FACTORY_DEFAULT_DE, STRING_SET_COMMON_FACTORY_DEFAULT_TITLE,NULL,ID_SETTING_SET_BUTT_LF_BMP,ID_SETTING_SET_BUTT_RF_BMP},	// 5
...
//	GUI_OpenAlphaBlend();
	...
	gui_rect.x1 = gui_rect.x0 + p_item_res->string_content_rect.width;
	gui_rect.y1 = gui_rect.y0 + p_item_res->string_content_rect.height;
