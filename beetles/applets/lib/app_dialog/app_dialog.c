...
static __s32 on_dialog_key_up_action(H_WIN hwnd, __u32 keycode)
{
	...
	if(keycode==GUI_MSG_IR_RIGHT)	
		keycode = GUI_MSG_KEY_RIGHT;
	if(keycode==GUI_MSG_IR_LEFT)	
		keycode = GUI_MSG_KEY_LEFT;		


	if(keycode==GUI_MSG_IR_UP)	
		keycode = GUI_MSG_KEY_UP;
	if(keycode==GUI_MSG_IR_DOWN)	
		keycode = GUI_MSG_KEY_DOWN;	

		if(keycode==GUI_MSG_IR_LONGUP)	
			keycode = GUI_MSG_KEY_LONGUP;
		if(keycode==GUI_MSG_IR_LONGDOWN)	
			keycode = GUI_MSG_KEY_LONGDOWN;	
